        <div class="main-sidebar">
          <aside id="sidebar-wrapper">
            ...
            <ul class="sidebar-menu">
                  ...
                  @if(Auth::user()->isAdmin)<li class="{{ request()->is('admin*') ? 'active' : '' }}"><a class="nav-link" href="/admin"><i class="fas fa-user-shield"></i><span>Administration</span></a></li>@endif
            ...
            <div class="p-3 mt-4 mb-4 hide-sidebar-mini">
              <a href="/faq" class="btn btn-outline-info btn-lg btn-icon-split btn-block"><i class="far fa-question-circle"></i> <div>FAQ</div></a>
              <a href="/downloads" class="btn btn-outline-dark btn-lg btn-icon-split btn-block"><i class="fas fa-file-download"></i> <div>Downloads</div></a>
            </div>
          </aside>
        </div>